      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="grid grid-cols-2 gap-3 w-full max-w-[360px] mx-auto">
          {OPTIONS.map((opt) => (
            <motion.button
              key={opt.id}
              className="bg-surface border border-ink/5 shadow-card rounded-2xl px-4 py-4 text-center cursor-pointer hover:shadow-elevated transition-shadow duration-200 flex flex-col items-center gap-3"
