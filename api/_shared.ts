...
export function getGuide(): string {
  ...
  try {
    // In Vercel serverless, look for the guide in reviewapp-premium
    const guidePath = path.join(process.cwd(), 'reviewapp-premium', 'src', 'architecture', 'REVIEW_GENERATION_GUIDE.md');
